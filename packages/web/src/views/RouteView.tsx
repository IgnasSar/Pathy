...
export function RouteView() {
      ...
      >
        <div
          ...
          style={{
            ...
            border: "2px dashed rgb(52 199 89 / 0.3)",
          }}
        >
          🗺️
        </div>
  ...
  return (
    <div
      ...
      style={{ paddingTop: "0.75rem", paddingBottom: "6rem" }}
    >
      {/* ── Top bar: title + clear ───────────────────────────────────── */}
      ...
      >
        <button
          ...
          style={{
            background:
              viewMode === "list" ? "rgb(52 199 89 / 0.15)" : "transparent",
            color: viewMode === "list" ? "rgb(52 199 89)" : "rgb(130 145 170)",
            border:
              viewMode === "list"
                ? "1px solid rgb(52 199 89 / 0.3)"
        ...
        <button
          ...
          style={{
            background:
              viewMode === "map" ? "rgb(52 199 89 / 0.15)" : "transparent",
